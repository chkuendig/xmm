...
class FilePropertiesIFO extends FileProperties {
	...
	for (int i = 0; i < numberOfTitles; i++) {
	    ...
	    runtime[i] += Integer.parseInt(Integer.toHexString(ifoFile[pointer + startcode + 4]), 16)*60*60; /*Hours*/
	    runtime[i] += Integer.parseInt(Integer.toHexString(ifoFile[pointer + startcode + 5]), 16)*60; /*Minutes*/
	    runtime[i] += Integer.parseInt(Integer.toHexString(ifoFile[pointer + startcode + 6]), 16); /*Seconds*/
