...
public class DatabaseMySQL extends Database {
	...
	try {
		...
		statement = _sql.prepareStatement("INSERT INTO General_Info "+
						  "(ID,Title,Cover,Imdb,Date,Directed_By,Written_By,Genre,Rating,Seen,Aka,Country,Language,Colour,Plot,Cast,Notes,CoverData,Certification,Mpaa,Sound_Mix,Web_Runtime,Awards) "+
						  "VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?);");
	...
	try {
	    ...
	    statement.setBytes( 17, model.getCoverData());
	...
	try {
		...
		statement = _sql.prepareStatement("INSERT INTO General_Info_Episodes "+
						      "(ID,Title,Cover,UrlKey,Date,Directed_By,Written_By,Genre,Rating,Seen,Aka,Country,Language,Colour,Plot,Cast,Notes,movieID,episodeNr,CoverData,Certification,Sound_Mix,Web_Runtime,Awards) "+
						      "VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?);");
	...
	try {
	    ...
	    String query = "SELECT General_Info.ID, ";
	    
	    if (getCoverData)
		query += "General_Info.CoverData, ";
	    
	    query += "General_Info.Imdb, "+
		"General_Info.Cover, "+
		"General_Info.Date, "+
		"General_Info.Title, "+
		"General_Info.Directed_By, "+
